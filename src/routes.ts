...
import {isAuthenticated, isSocialMediaLogin} from "./middlewares/isAuthenticated";
...
router.post('/sessionSocialmedia', isSocialMediaLogin ,new AuthUserController().handleSocialMedia)
