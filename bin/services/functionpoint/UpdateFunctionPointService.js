...
exports.UpdateFunctionPointService = void 0;
const prisma_1 = __importDefault(require("../../prisma"));
class UpdateFunctionPointService {
    execute({ id, project_id, type, estimate_functional_size, count_functional_size, created_by, updated_by, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield prisma_1.default.functionPoint.update(query);
        });
    }
}
exports.UpdateFunctionPointService = UpdateFunctionPointService;
